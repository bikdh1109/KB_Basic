...
public class Example {
    public static void main(String[] args) {
        ...
        Consumer<String> consumer = (String str) -> System.out.println(str + " 출력됨");
        consumer.accept("안녕하세요");

        // Supplier<T>#get() - T : 객체 t를 반환한다.
        Supplier<LocalDateTime> supplier = () -> LocalDateTime.now().withNano(999999999);
        ...
        // BinaryOperator<T>#apply(T t1, T t2) - T : t1과 t2를 연산하여 리턴
